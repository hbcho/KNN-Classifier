...
######################## end of data loading ####################################
    if (classifier == 'knn'):
        f2 = open('ErrorMatrix.txt','w')
    elif (classifier == 'modified_knn'):
        f2 = open('ErrorMatrixMknn.txt','w')
...
# cross_validate(l,'knn')            #cross-validate using normal knn (generates 'ErrorMatrix.txt')
# cross_validate(l,'modified_knn')   #cross_validate using modified knn (generates 'ErrorMatrixMknn.txt')

# err = open('ErrorMatrixMknn.txt','r') #comment out for normal knn and uncomment the below line...
err = open('ErrorMatrix.txt','r')
l = err.readline()
l = l.split('][')
